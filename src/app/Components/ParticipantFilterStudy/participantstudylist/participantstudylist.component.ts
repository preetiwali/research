...
@Component({
  ...
  templateUrl: './participantstudylist.component.html',
  styleUrls: ['./participantstudylist.component.sass']
})
export class ParticipantstudylistComponent implements OnInit {
  ...
  studyparticipated(id){
    this.formGroup.value.participation_selection = id
    this.rest.studyparticipated(this.study_id,this.formGroup.value).subscribe((data: { }) => {
    });
  }
