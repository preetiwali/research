...
@Component({
  selector: 'app-description-study',
  templateUrl: './description-study.component.html',
  styleUrls: ['./description-study.component.sass']
})
export class DescriptionStudyComponent implements OnInit {
