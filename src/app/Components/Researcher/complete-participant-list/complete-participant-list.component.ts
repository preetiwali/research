...
@Component({
  selector: 'app-complete-participant-list',
  templateUrl: './complete-participant-list.component.html',
  styleUrls: ['./complete-participant-list.component.sass']
})
export class CompleteParticipantListComponent implements OnInit {
