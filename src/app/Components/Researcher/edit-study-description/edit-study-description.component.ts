...
@Component({
  selector: 'app-edit-study-description',
  templateUrl: './edit-study-description.component.html',
  styleUrls: ['./edit-study-description.component.sass']
})
export class EditStudyDescriptionComponent implements OnInit {
  ...
  editStudyDescription(id) {
    this.rest.editStudy(this.editstudydescription.value, id).subscribe((data: { message: any, Data: any }) => {
