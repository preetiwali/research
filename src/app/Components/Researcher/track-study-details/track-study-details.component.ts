...
@Component({
  selector: 'app-track-study-details',
  templateUrl: './track-study-details.component.html',
  styleUrls: ['./track-study-details.component.sass']
})
export class TrackStudyDetailsComponent implements OnInit {
