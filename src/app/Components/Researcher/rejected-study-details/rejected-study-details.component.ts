...
// rejected-study-details

@Component({
  selector: 'app-rejected-study-details',
  templateUrl: './rejected-study-details.component.html',
  styleUrls: ['./rejected-study-details.component.sass'],
  providers: [DatePipe]

})
export class RejectedStudyDetailsComponent implements OnInit {
