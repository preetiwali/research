...
@Component({
  selector: 'app-edit-new-study',
  templateUrl: './edit-new-study.component.html',
  styleUrls: ['./edit-new-study.component.sass'],
  providers: [DatePipe]
})
export class EditNewStudyComponent implements OnInit {
