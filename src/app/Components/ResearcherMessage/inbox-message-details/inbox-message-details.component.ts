...
@Component({
  selector: 'app-inbox-message-details',
  templateUrl: './inbox-message-details.component.html',
  styleUrls: ['./inbox-message-details.component.sass']
})
export class InboxMessageDetailsComponent implements OnInit {
