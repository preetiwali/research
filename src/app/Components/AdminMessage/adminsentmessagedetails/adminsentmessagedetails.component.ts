...
@Component({
  selector: 'app-adminsentmessagedetails',
  templateUrl: './adminsentmessagedetails.component.html',
  styleUrls: ['./adminsentmessagedetails.component.sass']
})
export class AdminsentmessagedetailsComponent implements OnInit {
