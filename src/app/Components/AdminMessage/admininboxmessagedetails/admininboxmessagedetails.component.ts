...
@Component({
  selector: 'app-admininboxmessagedetails',
  templateUrl: './admininboxmessagedetails.component.html',
  styleUrls: ['./admininboxmessagedetails.component.sass']
})
export class AdmininboxmessagedetailsComponent implements OnInit {
