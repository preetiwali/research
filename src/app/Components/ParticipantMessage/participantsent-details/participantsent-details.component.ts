...
@Component({
  selector: 'app-participantsent-details',
  templateUrl: './participantsent-details.component.html',
  styleUrls: ['./participantsent-details.component.sass']
})
export class ParticipantsentDetailsComponent implements OnInit {
  ...
  replyMessage() {
    ...
    this.rest.newMessage(this.replymessage.value).subscribe((data: { message: any }) => {
      if (data.message === 'message-sent') {
        ...
        this.router.navigateByUrl('/participantsentdetails/' +this.message_id);
