...
@Component({
  selector: 'app-participant-inbox-details',
  templateUrl: './participant-inbox-details.component.html',
  styleUrls: ['./participant-inbox-details.component.sass']
})
export class ParticipantInboxDetailsComponent implements OnInit {
  ...
  replyMessage() {
    ...
    this.rest.newMessage(this.replymessage.value).subscribe((data: { message: any }) => {
      if (data.message === 'message-sent') {
        ...
        this.router.navigateByUrl('/participantinboxdetails/' +this.message_id);
