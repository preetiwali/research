...
@Component({
  selector: 'app-researcher-help-header',
  templateUrl: './researcher-help-header.component.html',
  styleUrls: ['./researcher-help-header.component.sass']
})
export class ResearcherHelpHeaderComponent implements OnInit {
