...
@Component({
  selector: 'app-researcher-first-login',
  templateUrl: './researcher-first-login.component.html',
  styleUrls: ['./researcher-first-login.component.sass']
})
export class ResearcherFirstLoginComponent implements OnInit {
